...
$lang->ai->models->typeList['ollama']       = 'Ollama (Lokal)';
...
$lang->ai->models->vendorTips->openrouter       = 'OpenRouter bietet Zugang zu Hunderten von Modellen. Geben Sie die Modellkennung ein (z.B. anthropic/claude-3.5-sonnet, openai/gpt-4o).';
$lang->ai->models->vendorTips->ollama           = 'Ollama führt Modelle lokal aus. Der API-Schlüssel ist bei lokalen Installationen optional. Standardadresse: http://localhost:11434';
