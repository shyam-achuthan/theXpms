...
$lang->ai->models->vendorTips->openrouter       = "OpenRouter donne accès à des centaines de modèles. Entrez l'identifiant du modèle (ex. anthropic/claude-3.5-sonnet, openai/gpt-4o).";
$lang->ai->models->vendorTips->ollama           = "Ollama exécute les modèles localement. La clé API est facultative pour les déploiements locaux. Adresse par défaut : http://localhost:11434";
